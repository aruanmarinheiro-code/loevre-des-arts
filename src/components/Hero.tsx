...
export default function Hero() {
  return (
    <section className="relative w-full h-screen overflow-hidden bg-[#F5F3EF]">
      ...
      {/* Bottom content */}
      <div className="absolute bottom-0 left-0 right-0 pb-10 md:pb-14 z-10 flex justify-center">
        <Link
          href="/shop"
          className="font-sans text-[10px] tracking-[0.25em] uppercase bg-white text-black px-10 py-3.5 hover:bg-white/80 transition-colors text-center whitespace-nowrap"
        >
          Ver Coleção
        </Link>
      </div>
